...
const customerAndAge = (obj) => {
  ...
  for (let element in obj)
    outArr.push(`Customer Name :${element} , Age :${obj[element]}`);
...
const getEntries = (obj) => {
  ...
  let outArr = [];
  for (let element in obj)
    outArr.push(`${element}: ${obj[element]}`);
...
const getInfo = (arr) => {
  ...
  for (let element of arr) {
    ...
    for (let innerElement of element.Students) 
      studentsName.push(innerElement);
  }
...
const getStudents = (arr) => {
  ...
  // for (let element of arr) {
  //   for (let innerElement of element.Students) 
  //     outArr.push({Student: `${innerElement}`, course: `${element.course}`});
  // }
